...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2024 at 12:02 AM
...
--
ALTER TABLE `tbl_inventory`
  ADD CONSTRAINT `tbl_inventory_ibfk_1` FOREIGN KEY (`products_id`) REFERENCES `tbl_product` (`p_id`) ON DELETE CASCADE;
COMMIT;
