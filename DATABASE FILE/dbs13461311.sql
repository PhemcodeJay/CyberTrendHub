...
-- Generation Time: Nov 14, 2024 at 07:17 AM
...
INSERT INTO `tbl_order` (`id`, `product_id`, `product_name`, `customer_email`, `size`, `color`, `quantity`, `unit_price`, `payment_id`, `aliexpress_order_id`, `cj_order_id`, `tracking_number`, `carrier`, `order_status`, `shipping_status`, `estimated_delivery`, `download_code`, `created_at`) VALUES
(1, 83, 'Men\'s Ultra Cotton T-Shirt, Multipack', '', 'XL', 'Gray', 1, '19.00', '1647629329', NULL, NULL, NULL, NULL, 'Pending', 'Processing', NULL, NULL, '2024-11-05 20:22:04'),
(2, 92, 'Travelpro Laptop Carry-on Travel Tote Bag', '', 'One Size for All', 'Midnight Blue', 1, '91.00', '1647798593', NULL, NULL, NULL, NULL, 'Pending', 'Processing', NULL, NULL, '2024-11-05 20:22:04'),
(4, 101, 'Digital Infrared Thermometer for Adults and Kids', '', 'One Size for All', 'White', 1, '70.00', '1647799174', NULL, NULL, NULL, NULL, 'Pending', 'Processing', NULL, NULL, '2024-11-05 20:22:04'),
(5, 94, 'WD 5TB Elements Portable External Hard Drive HDD', '', '5T', 'Black', 1, '149.00', '1647800902', NULL, NULL, NULL, NULL, 'Pending', 'Processing', NULL, NULL, '2024-11-05 20:22:04');
...
INSERT INTO `tbl_product` (`p_id`, `p_name`, `p_old_price`, `p_current_price`, `p_qty`, `p_featured_photo`, `p_description`, `p_short_description`, `p_feature`, `p_condition`, `p_return_policy`, `p_total_view`, `p_is_featured`, `p_is_active`, `ecat_id`, `aliexpress_product_id`, `cj_product_id`, `source_url`, `vendor_name`, `inventory_sync`) VALUES
