...
--
-- Host: 127.0.0.1    Database: dbs13461311
-- ------------------------------------------------------
...
CREATE TABLE `tbl_customer` (
  ...
  KEY `cust_b_country` (`cust_b_country`),
  KEY `cust_s_country` (`cust_s_country`)
...
DROP TABLE IF EXISTS `tbl_digital_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `tbl_digital_products` WRITE;
/*!40000 ALTER TABLE `tbl_digital_products` DISABLE KEYS */;
INSERT INTO `tbl_digital_products` VALUES (1,'Crypto Made Simple','The Essential Guide to Digital Wealth',9.99,'uploads/files/Crypto Made Simple.pdf',1,NULL),(2,'Essential-Trading-Guide','Essential Trading Guide',9.99,'uploads/files/Essential-Trading-Guide.pdf',1,NULL);
/*!40000 ALTER TABLE `tbl_digital_products` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_order` VALUES (1,83,'Men\'s Ultra Cotton T-Shirt, Multipack','','XL','Gray',1,19.00,NULL,'1647629329',NULL,NULL,NULL,'Pending','Processing',NULL,NULL,'2024-11-05 20:22:04'),(2,92,'Travelpro Laptop Carry-on Travel Tote Bag','','One Size for All','Midnight Blue',1,91.00,NULL,'1647798593',NULL,NULL,NULL,'Pending','Processing',NULL,NULL,'2024-11-05 20:22:04'),(4,101,'Digital Infrared Thermometer for Adults and Kids','','One Size for All','White',1,70.00,NULL,'1647799174',NULL,NULL,NULL,'Pending','Processing',NULL,NULL,'2024-11-05 20:22:04'),(5,94,'WD 5TB Elements Portable External Hard Drive HDD','','5T','Black',1,149.00,NULL,'1647800902',NULL,NULL,NULL,'Pending','Processing',NULL,NULL,'2024-11-05 20:22:04');
...
INSERT INTO `tbl_shipping_cost_all` VALUES (1,'100'),(1,'100');
...
DROP TABLE IF EXISTS `tbl_shipping_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `tbl_shipping_info` WRITE;
/*!40000 ALTER TABLE `tbl_shipping_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_shipping_info` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_slider` VALUES (1,'slider-1.png','Welcome to CyberTrendHub','Shop Online for Latest Products','View Products','product-category.php?id=1&type=top-category','Center'),(2,'slider-2.jpg',' Whooping Discount on All Products','Top Offers, Amazing Prices, Shop big while on budget.','See More','product-category.php?id=4&type=mid-category','Center'),(3,'slider-3.png','24 Hours Customer Support','Dedicated customer feedback and support, Customer satisfaction is guaranteed.','Contact Us','contact.php','Right');
...
INSERT INTO `tbl_social` VALUES (1,'Facebook','https://www.facebook.com/cybertrendhub','fa fa-facebook'),(2,'Twitter','https://www.twitter.com/phemcodejay','fa fa-twitter'),(3,'LinkedIn','','fa fa-linkedin'),(4,'Google Plus','','fa fa-google-plus'),(5,'Pinterest','','fa fa-pinterest'),(6,'YouTube','https://www.youtube.com/@cybertrendhub','fa fa-youtube'),(7,'Instagram','https://www.instagram.com/cybertrendhub','fa fa-instagram'),(8,'Tumblr','','fa fa-tumblr'),(9,'Flickr','','fa fa-flickr'),(10,'Reddit','','fa fa-reddit'),(11,'Snapchat','','fa fa-snapchat'),(12,'WhatsApp','https://wa.me/254101674289','fa fa-whatsapp'),(13,'Quora','','fa fa-quora'),(14,'StumbleUpon','','fa fa-stumbleupon'),(15,'Delicious','','fa fa-delicious'),(16,'Digg','','fa fa-digg');
...
-- Dump completed on 2024-11-15 23:22:35
